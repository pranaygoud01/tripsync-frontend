...
const Login = () => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    setError('Servers are hosted for free, so it may take a few seconds...');

    try {
      const response = await axios.post(
        'https://tripsync-backend-yovp.onrender.com/api/user/login',
        { email, password }
      );
  ...
  return (
    <>
      <div className='w-full h-[100vh] max-lg:h-fit flex max-lg:flex-col gap-10'>
        <img 
          src='https://images.unsplash.com/photo-1611159063981-b8c8c4301869?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' 
        ...
        <div className='flex flex-col w-[40%] max-lg:w-full max-lg:p-7 max-lg:pt-3 p-26'>
          ...
          <p className='font-semibold text-sm text-neutral-800 mt-2'>
            ...
            <span className='underline text-blue-500'><Link to='/signup'>Create here</Link></span>
          </p>
